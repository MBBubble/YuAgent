...
public class LoveApp {
    ...
    /**
     * 初始化聊天客户端 chatClient，使用chatModel
    ...
    public LoveApp(ChatModel dashscopeChatModel) {
        ...
        chatClient = ChatClient.builder(dashscopeChatModel)
                ...
                .defaultAdvisors(
                        ...
                        // 使用自定义的日志 advisor
                        ,new MyLoggerAdvisor()
                        // 使用自定义的推理增强 advisor Re-Reading，开启会增加输入的成本 token
...
//                .build();
    ...
    public String doChatWithRag(String message, String chatId) {
        ChatResponse chatResponse = chatClient
                ...
                // 基于本地知识库 Rag
                .advisors(new QuestionAnswerAdvisor(localVectorStore))
                .call()
                .chatResponse();
     ...
     * @return
     */
    public String doChatWithRagBaseCloud(String message, String chatId) {
        ChatResponse chatResponse = chatClient
                .prompt()
                .user(message)
                .advisors(spec -> spec.param(CHAT_MEMORY_CONVERSATION_ID_KEY, chatId)
